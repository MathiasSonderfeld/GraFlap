...
public class CYKAnswerMessage extends AnswerMessage {
     ...
     */
    public CYKAnswerMessage(int percentOfTestWordsFailed, String taskTitle, String bestLanguage, String taskMode, String taskType, String submissionType, Element svg) {
