package de.HsH.inform.GraFlap.file;
...
public class TuringConverter {
    ...
    private TransitionSet<MultiTapeTMTransition> transitions;
    private InputAlphabet alphabet;
    private TapeAlphabet tapeAlphabet;
