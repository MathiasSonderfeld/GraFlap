...
public class BlackBoxCorrectGrammarTest{
    ...
    void testGrammarForIntegers() {
        ...
        arguments.setMode(mode);
        arguments.setType(Type.RL);
        arguments.setTestwords(TestwordsUtil.getListTestWords("0%9%-2%91%24%-10%-20%437%-32%350%720%887%-791%-253%-532%-268%-319%-680%-973%-807%-431!-%-0%00%-00%-1-2%00884%00687%00695%00224%00957%00855%00806%00656" +
