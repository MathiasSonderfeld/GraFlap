...
public class BlackBoxCorrectOtherTest{
    ...
    void testCYKforGrammar() {
        ...
        arguments.setTestwords(TestwordsUtil.getSingleWordTestwords("aaabbb"));
    ...
    void testMealyForSmoothingBinaryImages() {
        ...
        arguments.setTestwords(TestwordsUtil.getTestWordsList("01%10%001%010%011%1010010%00101101"));
    ...
    void testTuringForBinaryToUnaryNumbers() {
        ...
        arguments.setTestwords(TestwordsUtil.getPairsTestWords("0001101;|||||||||||||%10;||%10001;|||||||||||||||||%10101;|||||||||||||||||||||%11001;|||||||||||||||||||||||||%11;|||%1101;|||||||||||||%10111;|||||||||||||||||||||||%10010;||||||||||||||||||%1010;||||||||||%11000;||||||||||||||||||||||||%100;||||%10110;||||||||||||||||||||||%1000;||||||||%10000;||||||||||||||||%1100;||||||||||||%111;|||||||%1111;|||||||||||||||%110;||||||%1;|%1001;|||||||||%1110;||||||||||||||%10100;||||||||||||||||||||%0;%1011;|||||||||||"));
