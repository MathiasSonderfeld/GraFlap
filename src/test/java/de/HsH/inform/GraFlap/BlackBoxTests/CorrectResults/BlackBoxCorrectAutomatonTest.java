...
public class BlackBoxCorrectAutomatonTest{
    ...
    void testAutomatonForEvenNumberOfW() {
        ...
        arguments.setTestwords(TestwordsUtil.getListTestWords("xxxxxxx%xxxxxxxxxxxwxwxxwxwxxwxwxxwxwxxwxwxxwxw%xxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxxxwxxx" +
    ...
    void testAutomatonForBinaryNumbers() {
        ...
        Testwords testwords = TestwordsUtil.getListTestWords("0010%111100000010%1100111111110011001100001110001100%0000110011001111001110101010010111%1100000000001100000011111110111010" +
